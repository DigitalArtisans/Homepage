...
export default function splash({ name, org, logo, active, total, channels, iframe }){
  let div = dom('.splash',
    ...
    !iframe && dom('.about',
      ...
      dom('p', 'We come here to communicate with our peers, to collaborate on wonderful new ideas and to discuss which thrift store truely has the most beautiful chequered shirts.'),
