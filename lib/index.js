...
export default function slackin({
  ...
  app.get('/', (req, res) => {
    ...
    let page = dom('html',
      dom('head',
        dom('title',
          'Digital Artisans - A Slack community for designers, developers and other web workers.'
        ),
        dom('meta name=viewport content="width=device-width,initial-scale=1.0,minimum-scale=1.0,user-scalable=no"'),
        dom('link rel="shortcut icon" href=https://raw.githubusercontent.com/DigitalArtisans/Homepage/master/lib/assets/logo.png'),
